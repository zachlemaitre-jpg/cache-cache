...
function generateInitialState() {
    ...
    if (mapIndex === 0) {
        ...
        addWallBlock(8, 28, 4, 1);  // Mur horizontal (remonté d'un cran pour laisser un passage en bas)
        ...
        // Dressing (3 cases de large, taille parfaitement proportionnelle)
        furnitures.push({ x: 129, y: 330, width: 48, height: 80, type: TILES.DRESSING, scale: 48/36 });
        ...
        //Chaise1
        furnitures.push({ x: 539, y: 55, width: 35, height: 35, type: TILES.CHAIR });
        //Chaise2
        furnitures.push({ x: 586, y: 105, width: 35, height: 35, rotation: 90, type: TILES.CHAIR });
        //Chaise3
        furnitures.push({ x: 488, y: 100, width: 35, height: 35, rotation: 270, type: TILES.CHAIR });
        //Chaise4
        ...
        // chaudière cuisine
        furnitures.push({ x: 843, y: 262, width: 32, height: 32, type: TILES.BOILER });
